...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/themes-tab.png" alt="The Themes tab open in the form editor, showing the theme settings panel."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/theme-dropdown.png" alt="The Theme dropdown under the General category listing the available theme presets."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/dark-theme.png" alt="The Light and Dark toggle switched to Dark."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/panels-with.png" alt="Form questions each shown inside their own box."></div>

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/panels-without.png" alt="The same form questions shown without individual boxes."></div>
...
5. Choose a **Logo fit** option: None, [Contain](styling-your-form.md#contain), [Cover](styling-your-form.md#cover), or [Fill](styling-your-form.md#fill).

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/add-logo1.png" alt="The logo upload field and sizing options in the Survey Header category."></div>

To position the logo, switch to the **Themes** tab, open the **Header** category, and set the **Logo alignment** property.

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/add-logo2.png" alt="The Logo alignment property in the Header category."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/title-description.png" alt="The Text width property that controls the header text area."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/customize-fonts.png" alt="Font family, weight, color, opacity, and size controls for the title and description."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/align-text.png" alt="The alignment controls for the survey title and description."></div>
...
* **Background color** — choose None, [Accent](styling-your-form.md#accent), or Custom (with a color picker).
* **Background image** — paste a link or upload a file, then set the display style (Cover, [Stretch](styling-your-form.md#stretch), Contain, or [Tile](styling-your-form.md#tile)), the opacity, and whether the header content overlaps the image.

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/customize-header-area1.png" alt="The Height and Height on smartphones properties for the header."></div>

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/customize-header-area2.png" alt="The header Background color options: None, Accent, and Custom."></div>

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/customize-header-area3.png" alt="The header Background image settings with display, opacity, and overlap controls."></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/customize-header-area4.png" alt="The Content area width property in the advanced header settings."></div>
...
* **Image display** — choose [Auto](styling-your-form.md#auto), Contain, or Cover.
* **Image position** — toggle between Fixed and Scroll.
* **Opacity** — set how transparent the background appears.

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/background-options.png" alt="The form Background settings: color, image, display style, position, and opacity."></div>
