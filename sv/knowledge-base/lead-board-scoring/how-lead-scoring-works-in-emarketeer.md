...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/1.-lead-scoring-view-1024x591.png" alt="Vyn för lead scoring i eMarketeer."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/2.-Name-score-set.gif" alt="Namnger en score-uppsättning."></div>

3. Klicka på "add a new rule" och ge den ett tydligt namn.

<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/3.-Name-rule.gif" alt="Namnger en regel."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/4.-Choose-rule-category-1024x592.png" alt="Välja en regelkategori."></div>

För en webbinarieregistrering, välj engagemang -> formulär -> det specifika formuläret -> skickade in.

<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/5.-Build-rule.gif" alt="Bygger en regel för en webbinarieformulär-inskickning."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/5.-Choose-occurrence-e1622552797474-1024x338.png" alt="Väljer förekomst för en regel."></div><div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/6.-Choose-time-frame-e1622552817660-1024x376.png" alt="Väljer en tidsram för en regel."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/7.-Combine-criteria.gif" alt="Kombinerar kriterier med AND."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/8.-Add-points.gif" alt="Lägger till poäng till en regel."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/9.-Activate-score-set.gif" alt="Aktiverar en score-uppsättning."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/image-10.png" alt="En kontaktprofil som visar en lista över lead score-regler kontakten uppfyllt tillsammans med kontaktens aktuella lead score."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/Filter-out-MQLs.gif" alt="Filtrerar kontakter efter lead score."></div>
...
<div data-with-frame="true"><img src="../../../assets/how-lead-scoring-works-in-emarketeer/Lead-scores-in-contact-lists-buttons.png" alt="Knappar för massåtgärder och export på en kontaktlista."></div>
