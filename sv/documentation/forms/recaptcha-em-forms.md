...
Du kanske minns tidigare versioner av CAPTCHA som bad dig identifiera objekt i bilder eller tyda förvrängd text. reCAPTCHA v3 fungerar annorlunda: det analyserar hur besökare interagerar med sidan och använder den signalen för att avgöra om de är människor eller botar. Besökare avbryts inte när de skickar in ditt formulär.

För mer detaljer, se [Googles dokumentation om reCAPTCHA](https://www.google.com/recaptcha/about/).

## Stäng av reCAPTCHA

Du kan stänga av reCAPTCHA för formulär på ditt konto från sidan för integrationsinställningar i **Account**.
