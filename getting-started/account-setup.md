...
Getting your account ready involves a handful of one-time steps. Adding an email domain is required before you can send; the rest are optional but expand what the platform can do for you. Work through the checklist below at your own pace.
...
- [ ] **Add an email domain** _(required to send email)_
