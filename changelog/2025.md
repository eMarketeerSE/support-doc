...
The dashboard requires the new web tracker script to be installed on your website. Without it, no website traffic data will show. [Read how to install the tracker here.](../documentation/web-tracker/README.md)
...
See [The web tracker](../documentation/web-tracker/README.md) and the [installation instructions](../documentation/web-tracker/installing-the-web-tracker-script-on-your-website.md).
{% endupdate %}
