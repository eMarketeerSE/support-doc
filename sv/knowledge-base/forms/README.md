...
Formulärinlämningar registreras som kontaktaktivitet. Varje formulär ger dig en rapport över vilka kontakter som har svarat och när. Du kan också använda inlämningar för att utlösa [Journeys](../journeys/journeys.md), bygga [leadpoängsregler](../lead-board-scoring/how-lead-scoring-works-in-emarketeer.md) kring formulärengagemang eller dirigera kontakter till [leadströmmar](../lead-board-scoring/lead-streams.md). Med [Web Tracker](../../documentation/web-tracker/) installerat på din webbplats identifierar formulärinlämningar även respondenten och kopplar deras besökshistorik till kontaktposten, vilket låter dig spåra konverteringar från din webbplats.
