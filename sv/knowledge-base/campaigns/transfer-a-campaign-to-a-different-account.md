...
<div data-with-frame="true" data-align="left"><img src="../../../assets/transfer-a-campaign-to-a-different-account/Ska_CC_88rmavbild-2017-11-16-kl.-11.15.48.png" alt="EMID-uppslag under menyn Account"></div>
...
<div data-with-frame="true" data-align="left"><img src="../../../assets/transfer-a-campaign-to-a-different-account/Ska_CC_88rmavbild-2017-11-16-kl.-11.17.59.png" alt="Alternativet Transfer i kugghjulsmenyn för en kampanj"></div>

En dialogruta öppnas och frågar efter EMID för destinationskontot. Klistra in EMID:n du fick och klicka på "Fetch User".

<div data-with-frame="true" data-align="left"><img src="../../../assets/transfer-a-campaign-to-a-different-account/transferdialog.png" alt="Överföringsdialog med EMID-fält"></div>
