...
If you send from the default via-em.com domain, no action is needed. See [How to authenticate your domain](https://support.emarketeer.com/getting-started/account-setup/authorize-email-domain) for full instructions.
{% endupdate %}
