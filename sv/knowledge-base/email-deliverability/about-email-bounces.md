...
### Varför du behöver en låg studsfrekvens

För att blockera bedrägliga avsändare ger Internet Service Providers (ISP) varje avsändare ett ryktespoäng. Poängen baseras på flera faktorer, bland annat användarengagemang, spamklagomål och studsfrekvens. Ju högre din studsfrekvens är, desto sämre blir ditt avsändarrykte. En avsändare med dåligt rykte riskerar att blockeras helt.

En acceptabel studsfrekvens ligger runt 1–3 %. Om din är högre bör du se över dina utskicksrutiner.

### Hur eMarketeer hanterar dåliga adresser
...
### Så följer du din studsfrekvens
...
<div data-with-frame="true"><img src="../../../assets/about-email-bounces/Ska_CC_88rmavbild-2020-04-20-kl.-12.44.38.png" alt="studsfrekvens som visas i e-postrapporten"></div>
