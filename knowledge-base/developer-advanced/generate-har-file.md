...
![Chrome DevTools Network tab open](../../.gitbook/assets/SCR-20240522-jbvs.png)

4. Clear the logs before you reproduce the problem by clicking the clear button.

![clear network logs button in DevTools](../../.gitbook/assets/SCR-20240522-jcfi.png)
...
![red record button active in the Network tab](../../.gitbook/assets/SCR-20240522-jcqt.png)

6. If it isn't, check the Preserve log box.

![Preserve log checkbox in the Network tab](../../.gitbook/assets/SCR-20240522-jupc.png)
...
![Export HAR option in the download menu](../../.gitbook/assets/SCR-20240522-jdas.png)
