...
If you send from the default via-em.com domain, no action is needed. See [How to authenticate your domain](../knowledge-base/email-deliverability/authorize-email-domain.md) for full instructions.
{% endupdate %}
