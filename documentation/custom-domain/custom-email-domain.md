...
![add a domain dialog](../../.gitbook/assets/Skarmavbild-2024-03-21-kl.-09.58.27.png)

### 3. Update your DNS records

eMarketeer shows a list of records that need to be added to your DNS. When the records are added, click "Authenticate".

![DNS records to add for the new domain](../../.gitbook/assets/Skarmavbild-2024-03-21-kl.-09.58.42.png)
...
![authenticated domain with green-checked DNS records](../../.gitbook/assets/SCR-20240321-jgsz.png)
