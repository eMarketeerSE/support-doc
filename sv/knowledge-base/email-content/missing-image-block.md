---
description: >-
  Hur du hittar och tar bort dolda tomma bildblock som orsakar brutna bildfält i
  Outlook (kräver Developer-behörighet).
layout:
  width: default
  title:
    visible: true
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/outlook.png" alt="Röd-x-ruta som visas i Outlook på Windows där en bild borde renderas"></div>

Outlook (Windows)

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/outlook-mac.png" alt="Blå frågetecken-ruta som visas i Outlook på Mac där en bild borde renderas"></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/1.-Before.png" alt="E-postinnehåll med bilden synlig innan sökvägen är bruten"></div>

Innan bildens sökväg är bruten.

<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/2.-No-Block.png" alt="E-postinnehåll med bildblocket dolt efter att sökvägen är bruten"></div>
...
<div align="left" data-with-frame="true"><img src="../../.gitbook/assets/3.-User.png" alt="Användarkonto som visar att developer-behörigheten är aktiverad"></div>
...
2.  Gå in i developer mode.
    ...
    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/4.-dev-mode.png" alt="Knappen Enable Developer Mode i redigerarens verktygsfält"></div>
...
3.  Kontrollera namnen på alla synliga bildblock genom att välja varje och öppna fliken settings.
    ...
    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/5.-check-other-image-names.png" alt="Fliken settings som visar namnet på ett valt bildblock"></div>

    Kontrollera namnet på ett synligt bildblock.
4.  Gå in i Tree View.

    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/6.-tree-view.png" alt="Knappen Tree View i developer mode-verktygsfältet"></div>
...
5.  Hitta alla Image Full Width-block i listan och matcha deras containernamn med de synliga tills du hittar ett som inte matchar. I det här exemplet matchar inte _container1 (1 Column: Image Full Width)_ ett synligt bildblock.
    ...
    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/7.-tree-view-image-full-w.png" alt="Tree View som listar Image Full Width containerblock"></div>
...
6.  Välj bilddelen av blocket och ändra bildens URL genom att klicka på knappen Choose Image, välj sedan en ny bildfil i filvalsfönstret.
    ...
    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/7.-select-image-and-change-url.png" alt="Bildblock valt i Tree View med bild-URL-fältet markerat"></div>

    Hitta bildens URL.

    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/8.-select-new-image.png" alt="Filvalspopup med en ny bild vald"></div>

    Välj en ny bildfil.
7.  Spara ändringen, återgå sedan till Page View för att fortsätta redigera komponenten.

    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/9.-save-your-change.png" alt="Knappen Save markerad i redigerarens verktygsfält"></div>

    Knappen Save.

    <div align="left" data-with-frame="true"><img src="../../.gitbook/assets/10.-Result.png" alt="E-postkomponentens redigerare som nu visar den återställda bilden"></div>
