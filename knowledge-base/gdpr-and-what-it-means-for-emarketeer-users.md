...
The General Data Protection Regulation (GDPR) gives ownership and control of personal data back to EU citizens. EU residents have the right to be forgotten, the right to access their data, and the right to have it stored securely, among other protections. Data processors (you) and data controllers (eMarketeer) need to adjust processes to comply.
...
![](../assets/gdpr-and-what-it-means-for-emarketeer-users/GDPR-eMarketeer-Master-Presentation-1.jpg)
