...
2. Enter the domain you want to authorize (for example, `yourdomain.com`) and click to add.
   [![](../assets/authorize-email-domain/Ska_CC_88rmavbild-2019-12-11-kl.-14.31.57.png)](https://support.emarketeer.com/wp-content/uploads/2019/12/Skärmavbild-2019-12-11-kl.-14.31.57.png)
3. eMarketeer shows a list of DNS records. Add them to your DNS. If you do not have access to your company's DNS — often the IT department owns it — click the link in the authorize dialog to send the records to the person in charge.
   [![](../assets/authorize-email-domain/Ska_CC_88rmavbild-2019-12-11-kl.-14.30.16.png)](https://support.emarketeer.com/wp-content/uploads/2019/12/Skärmavbild-2019-12-11-kl.-14.30.16.png)
   [![](../assets/authorize-email-domain/Ska_CC_88rmavbild-2019-12-11-kl.-14.30.42.png)](https://support.emarketeer.com/wp-content/uploads/2019/12/Skärmavbild-2019-12-11-kl.-14.30.42.png)
...
5. If the records are correct, the dialog validates and accepts the authentication. If something is wrong, the failing record is marked in red.
   [![](../assets/authorize-email-domain/Ska_CC_88rmavbild-2019-12-11-kl.-14.31.00.png)](https://support.emarketeer.com/wp-content/uploads/2019/12/Skärmavbild-2019-12-11-kl.-14.31.00.png)
   [![](../assets/authorize-email-domain/Ska_CC_88rmavbild-2019-12-11-kl.-14.06.02.png)](https://support.emarketeer.com/wp-content/uploads/2019/12/Skärmavbild-2019-12-11-kl.-14.06.02.png)
