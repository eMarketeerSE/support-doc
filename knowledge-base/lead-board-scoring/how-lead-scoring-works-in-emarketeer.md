...
![Lead scoring view in eMarketeer.](../../.gitbook/assets/1.-lead-scoring-view-1024x591.png)
...
![Naming a score set.](../../.gitbook/assets/2.-Name-score-set.gif)

3. Click "add a new rule" and give it a clear name.

![Naming a rule.](../../.gitbook/assets/3.-Name-rule.gif)
...
![Choosing a rule category.](../../.gitbook/assets/4.-Choose-rule-category-1024x592.png)

For a webinar registration, choose engagement -> form -> the specific form -> submitted.

![Building a rule for a webinar form submission.](../../.gitbook/assets/5.-Build-rule.gif)
...
![Choosing occurrence for a rule.](../../.gitbook/assets/5.-Choose-occurrence-e1622552797474-1024x338.png) ![Choosing a time frame for a rule.](../../.gitbook/assets/6.-Choose-time-frame-e1622552817660-1024x376.png)
...
![Combining criteria with AND.](../../.gitbook/assets/7.-Combine-criteria.gif)
...
![Adding points to a rule.](../../.gitbook/assets/8.-Add-points.gif)
...
![Activating a score set.](../../.gitbook/assets/9.-Activate-score-set.gif)
...
![A contact profile showing a list of lead score rules that the contact fulfilled along with the current lead score the contact has.](../../.gitbook/assets/image-10.png)
...
![Filtering contacts by lead score.](../../.gitbook/assets/Filter-out-MQLs.gif)
...
![Bulk actions and export buttons on a contact list.](../../.gitbook/assets/Lead-scores-in-contact-lists-buttons.png)
