...
Att konfigurera ditt konto innebär ett antal engångssteg. En e-postdomän krävs innan du kan skicka; övriga steg är valfria men utökar vad plattformen kan göra för dig. Arbeta igenom checklistan nedan i din egen takt.
...
- [ ] **Lägg till en e-postdomän** _(krävs för att skicka e-post)_
